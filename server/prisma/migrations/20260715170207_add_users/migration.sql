...
INSERT INTO "new_Budget" ("amount", "categoryId", "createdAt", "id", "updatedAt") SELECT "amount", "categoryId", "createdAt", "id", "updatedAt" FROM "Budget";
DROP TABLE "Budget";
...
INSERT INTO "new_Transaction" ("amount", "categoryId", "createdAt", "date", "description", "id", "type") SELECT "amount", "categoryId", "createdAt", "date", "description", "id", "type" FROM "Transaction";
